...
class Bootstrap5 extends Paginator
{
     ...
     * @return string
     */
    protected function getPreviousButton($text = '<i class="layui-icon">&#xe65a;</i>')
    {
     ...
     * @return string
     */
    protected function getNextButton($text = '<i class="layui-icon">&#xe65b;</i>')
    {
        if (!$this->hasMore) {
            return $this->getDisabledTextWrapper($text);
        }
    ...
    protected function getLinks()
    {
        ...
        $rollPage = $this->rollPage-1;//分页栏每页显示的页数
